...
public class ProjectConfig implements WebMvcConfigurer {
    ...
    public LocaleResolver localeResolver() {
        ...
        slr.setDefaultLocale(Locale.getDefault()); //Español Computadora, osea pagina español
    ...
    public LocaleChangeInterceptor localeChangeInterceptor() {
        ...
        lci.setParamName("lang"); //lang= el usuario esta seleccionando el idioma español
        return lci;
    }
